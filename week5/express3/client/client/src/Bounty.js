        ...
        <div className= {`bounty ${type === 'Jedi' ? 'jedi-bg' : 'sith-bg'}`}>
            { !editToggle ?
                <>
                    ...
                    onClick={() => setEditToggle(prevEditToggle => !prevEditToggle)}>Edit</button>
                </>
                :
                <>
                    <AddBountyForm
                        toggle={setEditToggle} submit={editBounty} {...props}
                        buttonText="Submit"/> 
                
                    <button className='cancelEditB'
                     onClick={() => setEditToggle(prevEditToggle => !prevEditToggle)}>Cancel</button>
                </>
            }
        </div>
    )
